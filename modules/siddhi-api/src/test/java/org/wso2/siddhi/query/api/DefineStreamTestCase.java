...
public class DefineStreamTestCase {
    ...
    public void testCreatingStreamDefinition2() {
        StreamDefinition streamDefinition = QueryFactory.createStreamDefinition();
        streamDefinition.name("cseEventStream").attribute("symbol", Attribute.Type.STRING).attribute("price", Attribute.Type.INT).attribute("volume", Attribute.Type.FLOAT).attribute("data",Attribute.Type.OBJECT);
    }
