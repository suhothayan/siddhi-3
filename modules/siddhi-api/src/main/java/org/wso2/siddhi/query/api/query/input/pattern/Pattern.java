...
public class Pattern {
    ...
    public static PatternElement logical(StandardStream standardStream1, LogicalElement.Type type,
    ...
    public static PatternElement count(StandardStream standardStream, int min, int max) {
