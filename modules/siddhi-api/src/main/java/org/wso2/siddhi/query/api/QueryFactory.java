...
public abstract class QueryFactory {
    ...
    public static StandardStream inputStream(String streamId) {
        return new StandardStream(streamId, streamId);
    }
    ...
    public static StandardStream inputStream(String streamReferenceId, String streamId) {
        return new StandardStream(streamReferenceId, streamId);
